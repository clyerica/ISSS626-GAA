...
The following code chunk imports Master Plan 2019 Subzone (No Sea) dataset into R. - st_zm() removes Z (elevation) and M (measure) dimensions from geospatial geometries. - st_transform(crs=3414) transforms the projections to svy21
