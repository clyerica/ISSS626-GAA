...
Check for NAs in coords

```{r}
nas_in_X <- sum(is.na(biz_beautycare$X))
print(nas_in_X)
nas_in_Y <- sum(is.na(biz_beautycare$Y))
print(nas_in_Y)
```
...
```{r}
biz_beautycare_sf <- read_rds("data/rds/biz_beautycare_sf.rds")
```
